<?php 
session_start();
function phpAlert($msg,$msg2,$msg3,$msg4,$msg5) {
    echo '<script type="text/javascript">alert("' . $msg . $msg2 .$msg3 .$msg4 . $msg5  . '");</script>';
}	
if(!isset($_SESSION['u_error']))
{
	$_SESSION['u_error']='';
}
if(!isset($_SESSION['u2_error']))
{
	$_SESSION['u2_error']='';
}if(!isset($_SESSION['p_error']))
{
	$_SESSION['p_error']='';
}if(!isset($_SESSION['p2_error']))
{
	$_SESSION['p2_error']='';
...
if(isset($_GET['erro'])){
if($_GET['erro'] == 1)
phpAlert($_SESSION['u_error'],$_SESSION['u2_error'],$_SESSION['p_error'],$_SESSION['p2_error'],$_SESSION['login_error']);
}
?>
<html>
<head>
